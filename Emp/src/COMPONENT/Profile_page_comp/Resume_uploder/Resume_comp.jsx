...
import upload_btn_style from '../Profile_img_uploader/Profile_img.module.css'
...
const Resume_comp = ({ set_resume_form, set_background_blur }) => {
    ...
    return (
        <div className={style.app}>
            ...
            <center>
                <button onClick={handleUpload} className={`${style.btn} ${file_name ? upload_btn_style.btn2 : upload_btn_style.btn1}`}>
                    Upload
                </button>
            </center>
