...
const Password_reset = () => {
    ...
    const { values, errors, touched, handleBlur, handleChange, handleSubmit, setFieldValue } = useFormik({
        ...
        onSubmit: async (value, { resetForm }) => {
            ...
            // console.log(path)
            reset_password(value, path, restPassword, toast, set_React_loader, dispatch)
    ...
    return (
        <div className={style_main.main}>
            <div className={style_main.inside}>

                <center>
                    <img src={logo} alt="logo" className={style_main.logo} />
                </center>
                <div className={style.education_op}>

                    <h1 className={style_main.heading}>Reset your password</h1>
                    <br />
                    <p className={style_main.para}>It happens to the best of us! Enter a secure new password below to reset your account and keep your information safe.</p>
